...
export default function Notfound(props) {
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 text-not-found align-self-center">
      ...
      <div class="col-md-6 align-self-center eror-text" dir='rtl'>
        <h1 className='eror-title'>Eror 404</h1>
        <h2 className='my-5'>{props.message}</h2>
    <div className="btn-not-found ">
        <Link to={props.link} class="btn btn-dark">{props.btn}</Link>
    </div>
